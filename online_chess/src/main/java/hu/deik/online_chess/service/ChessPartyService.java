...
public interface ChessPartyService {
    ...
    ChessParty connectToGame(Player player, String gameId) throws InvalidParamException, InvalidGameException;
    ChessParty connectToRandomGame(Player player) throws NotFoundException;
